...
public interface ReviewService {
         ...
         * @return レビューリスト
         */
        PageResponse<ReviewResponse> getUserReviews(User user, Pageable pageable, String bookId);
         ...
         * @return レビューリスト
         */
        PageResponse<ReviewResponse> getBookReviews(String bookId, Pageable pageable);
