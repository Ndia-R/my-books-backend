...
public class FavoriteMapper {
    ...
    public FavoriteCursorResponse toFavoriteCursorResponse(List<Favorite> reviews, Integer limit) {
        ...
        return new FavoriteCursorResponse(hasNext, endCursor, responses);
    }
}
